...
python3 extract_partition_convert_dataset.py no imdb /hard-disk-2/users/aryavishe/IMDB-Wiki/imdb 0.2
...
#
./cluster.out /hard-disk-2/users/aryavishe/data/vggnet_features_imdb_train_features.bin /hard-disk-2/users/aryavishe/data/vggnet_features_imdb_val_features.bin 20
...
./cluster.out /hard-disk-2/users/aryavishe/data/vggnet_outputs_imdb_train_features.bin /hard-disk-2/users/aryavishe/data/vggnet_outputs_imdb_val_features.bin 20
